    ...
    async init() {
        ...
        if (process.env.RATSIT_COOKIES) {
            ...
            try {
                ...
                // Verifiera att session är giltig
                if (await this.verifySession()) {
                    this.log('✅ Session från miljövariabel giltig - redan inloggad!');
                    this.isLoggedIn = true;
                    return true;
                }

                this.log('Session från miljövariabel ogiltig - fortsätter med fil-cookies...');
            } catch (e) {
