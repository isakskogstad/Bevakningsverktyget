...
try {
    ...
    console.error('[BrowserFactory] puppeteer-real-browser ej tillgänglig');
}
...
function configurePuppeteer() {
    ...
    try {
        ...
        console.error('[BrowserFactory] Kunde inte ladda Adblocker plugin:', e.message);
    }

    isConfigured = true;
    console.error('[BrowserFactory] Puppeteer konfigurerad med Stealth' + (adblockerEnabled ? ' + Adblocker' : ''));
}
...
function getProxyConfig() {
    ...
    try {
        ...
        console.error('[BrowserFactory] Kunde inte parsa proxy URL:', e.message);
        return null;
    }
}
...
async function createBrowser(options = {}) {
    ...
    if (chromePath) {
        console.error('[BrowserFactory] Använder Chrome:', chromePath);
    }
    ...
    if (proxyConfig) {
        ...
        console.error('[BrowserFactory] Proxy konfigurerad:', proxyConfig.server);
    }
...
async function createRealBrowser(options = {}) {
    ...
    console.error('[BrowserFactory] Startar Real Browser med Turnstile-stöd...');
    ...
    try {
        ...
        console.error(`[BrowserFactory] Real Browser startad (headless: ${headless}, turnstile: ${turnstile})`);
        ...
        console.error(`[BrowserFactory] Real Browser fel: ${e.message}`);
        throw e;
    }
}
    ...
    if (useProxy) {
        ...
        if (proxyConfig && proxyConfig.username && proxyConfig.password) {
            try {
                ...
                console.error('[BrowserFactory] Proxy-autentisering konfigurerad');
            } catch (e) {
                console.error('[BrowserFactory] Proxy-autentisering misslyckades:', e.message);
            }
        }
    }
