...
const EMAIL_TO = process.env.EMAIL_TO || process.env.NOTIFICATION_EMAIL;
const EMAIL_FROM = process.env.EMAIL_FROM || 'Impact Loop <nyheter@impactloop.se>'; // Kräver verifierad domän i Resend
